        ...
        >
          <div className="flex flex-col max-w-lg gap-3">
            ...
            <p className="text-center text-[#4D5768]">
              Sign in to access your order history, track your
              shipments, and manage your account details. Once
              signed in, you can view all your past orders and
              easily reorder your favorite items.
            </p>
